...
enum custom_keycodes { MB_LBRC = SAFE_RANGE, MB_RBRC, MB_SCLN };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[DVORAK] = LAYOUT(KC_EQL, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, DE_TILD, KC_1, KC_2, KC_3, KC_4, KC_5, KC_TAB, KC_QUOT, KC_COMM, KC_DOT, KC_P, DE_Y, KC_ESC, KC_A, KC_O, KC_E, KC_U, KC_I, KC_LSFT, MB_SCLN, KC_Q, KC_J, KC_K, KC_X, KC_GRV, KC_INS, KC_LEFT, KC_RGHT, KC_LCTL, KC_LALT, TO(QWERTZ), KC_BSPC, KC_DEL, KC_END, KC_F9, KC_F10, KC_F11, KC_F12, KC_PSCR, KC_SLCK, KC_PAUS, KC_NO, RESET, KC_6, KC_7, KC_8, KC_9, KC_0, KC_RBRC, KC_F, KC_G, KC_C, KC_R, KC_L, KC_SLSH, KC_D, KC_H, KC_T, KC_N, KC_S, DE_MINS, KC_B, KC_M, KC_W, KC_V, DE_Z, KC_RSFT, KC_UP, KC_DOWN, MB_LBRC, MB_RBRC, KC_LWIN, KC_RALT, KC_PGUP, KC_PGDN, KC_ENTER, KC_SPC),
